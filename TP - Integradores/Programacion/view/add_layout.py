...
def add_layout(
    ...
    """
    Crea el layout completo de la pantalla para agregar países.
    
    Args:
        height: Alto de la ventana
        width: Ancho de la ventana
        nuevo_pais: Diccionario con datos del nuevo país
        status_msg: Mensaje de estado a mostrar
        campo_actual: Campo actualmente seleccionado
        
    Returns:
        Tupla con las ventanas de encabezado, menú de agregar y pie de página
    """
